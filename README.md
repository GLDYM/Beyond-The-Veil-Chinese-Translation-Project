...
登录 Crowdin 后，访问 https://zh.crowdin.com/editor/btv-chinese/27/en-zhcn 进行翻译。

如果有空，可以导出后向 BTV 源仓库提出 PR。

## 文件说明

- `lang`: 1.12.2 的翻译文件，可供标准译名对照与翻译风格参考
- `en_us.json`: 英文语言文件。当前提供版本为 [Other 'ending cutscene' animation · valeriotor/Beyond-The-Veil@c79ce65](https://github.com/valeriotor/Beyond-The-Veil/commit/c79ce653564bcbee2f5ef2e4202fb6e40c0a19c2)。
...
- 如果`en_us.json`新增了翻译键，踢一脚管理员及时增补。
